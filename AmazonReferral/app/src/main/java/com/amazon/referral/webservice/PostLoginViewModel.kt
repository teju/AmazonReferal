...
class PostLoginViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData(loginform : JSONObject) {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), Login::class.java)
        ...
        genericHttpAsyncTask.setPostParams(Keys.LOGINFORM,loginform)
