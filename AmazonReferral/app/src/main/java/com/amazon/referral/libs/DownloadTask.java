...
public class DownloadTask {
    ...
    private final LoadingCompound ld;
    ...
    public DownloadTask(Context context, Button buttonText, String downloadUrl,
                        LoadingCompound ld, NotifyListener notifyListener) {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                if (outputFile != null) {
                    ...
                    notifyListener.onButtonClicked(1);
                } else {
                    notifyListener.onButtonClicked(0);
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                System.out.println("doInBackground "+downloadUrl +" downloadFileName "+downloadFileName);
                ...
                Log.e(TAG, "Directory Created. "
                        +apkStorage.getAbsolutePath() +" exists "+apkStorage.exists());
