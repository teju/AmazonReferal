...
class PostGetVideosViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData(language : String) {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), Videos::class.java)
        ...
        genericHttpAsyncTask.setUrl(APIs.postGetVideos)
        ...
        genericHttpAsyncTask.setPostParams(Keys.LANGUAGE,language)
